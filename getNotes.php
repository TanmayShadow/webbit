...
<?php
    ...
    {    
        ...
        $query="select * from notes where year='".$_POST['year']."' and branch='".$_POST['branch']."'and subject='".$_POST['subject']."'";
        ...
        while ($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
            $link = "http://localhost/webbit/".$row['filelocation'];
            echo "<h4><a href='".$link."'>".$row['topic']."</a></h4><br>";
        }
        echo "</table>";
        echo "</div>";
    }
